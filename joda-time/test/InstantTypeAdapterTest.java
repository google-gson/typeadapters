...
public class InstantTypeAdapterTest {
  ...
  public void testSerialization() {
    Instant time = new Instant("2014-03-30T00:56:53.512-00:00");
  ...
  public void testDeserialization() {
    Instant instant = gson.fromJson("'2014-03-30T00:56:53.512-00:00'", Instant.class);
    assertEquals(DateTimeZone.UTC, instant.getZone());
    DateTime time = instant.toDateTime().toDateTime(DateTimeZone.UTC);
